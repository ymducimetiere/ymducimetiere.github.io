...
$$ \hat{u}_h = R(\omega_o) \hat{f}_h = \sum_{j} \frac{ q_j }{i\omega_o - \sigma_j} \frac{\langle q^{\dagger}_j \mid \hat{f}_h \rangle}{ \langle q^{\dagger}_j \mid q_j \rangle }. $$

Thereby,

$$ ||\hat{u}_h||^2 = \sum_{j} \frac{ ||q_j||^2 }{|i\omega_o - \sigma_j|^2} \frac{|\langle q^{\dagger}_j \mid \hat{f}_h \rangle|^2}{|\langle q^{\dagger}_j \mid q_j \rangle|^2 } + \sum_{j, k\neq j} \frac{ \langle q_j \mid  q_k \rangle }{(i\omega_o - \sigma_j)^*(i\omega_o - \sigma_k)} \frac{\langle q^{\dagger}_j \mid \hat{f}_h \rangle^* \langle q^{\dagger}_k \mid \hat{f}_h \rangle }{\langle q^{\dagger}_j \mid q_j \rangle^* \langle q^{\dagger}_k \mid q_k \rangle}.$$
