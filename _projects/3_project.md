...
By increasing the capillary number $$Ca$$, hydrodynamic-stress-driven mechanisms become dominant over the surface-tension-driven ones mentionned above. Therefore, above a certain threshold value $$Ca^*$$, the lateral breakup regime is not observed anymore, but one in which the droplet breaks in the center (&ldquo; central breakup &rdquo;) is found instead (see Fig. 2)    
